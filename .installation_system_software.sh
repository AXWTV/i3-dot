...
if [ "$DISTRO" == "debian" ] || [ "$DISTRO" == "ubuntu" ]; then
    ...
    sudo apt install -y i3-gaps polybar alacritty rofi vim dunst neovim feh snapd zsh btop lsd pavucontrol thunar ranger bluez* blueman
    ...
    sudo dnf install -y i3-gaps polybar btop dunst alacritty neofetch neovim vim rofi feh nitrogen zsh lsd pavucontrol thunar ranger bluez bluez-tools blueman
    ...
    sudo pacman -S i3-gaps polybar alacritty neofetch rofi btop pavucontrol dunst zsh lsd feh curl vim nvim thunar ranger bluez bluez-utils blueman && yay -S picom-git eww
    # flatpack flathub
    sudo dnf install flatpak
    sudo flatpak remote-add --if-not-exists flathub https://flathub.org/repo/flathub.flatpakrepo
    #zscroll
